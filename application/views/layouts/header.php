...
<link href="<?php echo asset_url('css/hobup_style.css') ?>" rel="stylesheet" media="screen" />
<link href="<?php echo asset_url('css/bootstrap_style.css') ?>" rel="stylesheet" media="screen" />
