...
<select multiple="multiple" name="groups[]" class="image-picker  limit_callback" data-limit="3">
  ...
  <option data-img-src="img/logo2.png" value="4">Drawing</option>
  <option data-img-src="img/logo1.png" value="5">Football</option>
  <option data-img-src="img/logo2.png" value="6">Gaming</option>
  <option data-img-src="img/logo1.png" value="7">Hiking</option>
  <option data-img-src="img/logo3.png" value="8">Motor sports</option>
  <option data-img-src="img/logo2.png" value="9">Photography</option>
