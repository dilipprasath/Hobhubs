<div class="login_box">
<div class="row-fluid">
<h4 class="lp_color">Sign Up using Facebook</h4>
...
<select required name="birthday_day" id="day" class="span3" disabled>
...
<select required name="birthday_year" id="year" class="span3" disabled>
...
<div class="row-fluid">
<label class="radio form-inline span4">
<input type="radio" name="hub1" class="input_radio " required disabled>Male
</label>&nbsp;
<label class="radio form-inline span4">
<input type="radio" name="hub1" class="input_radio " required disabled>
Female
</label>
</div>
