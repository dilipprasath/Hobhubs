                     ...
                     <td>
                        <table width="670" border="0" cellpadding="0" cellspacing="0" style="margin-left:14px">
                          ...
                          Recently a request was submitted to reset your password for our client area. If you did not request this, please ignore this email. It will expire and become useless in 2 hours time.<br>
                                    <br> 
                                    <br>
                                    <p style="text-align:center;margin:0;padding:0"> <b style="border:2px solid #4070a6;background-color:#3c79b7;padding:5px 17px 7px 17px"><a href="http:/hobhubs.com/test/user/pwreset/{salt} " style="font-weight:bold;text-decoration:none;font-size:12px;color:#ffffff" target="_blank">Reset Your Password</a></b></p>
                                    <br>
                                    <br> 
