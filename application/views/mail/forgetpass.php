                        ...
                        <table width="670" border="0" cellpadding="0" cellspacing="0" style="margin-left:14px">
                          ...
                          Recently a request was submitted to reset your password for our client area. If you did not request this, please ignore this email. It will expire and become useless in 2 hours time.<br>
                                  ...
                                  <br> 
                                    <b>Need help?</b>
                                    <br>
                                    This is a "no-reply" email address so you'll be unable to reply to it. For member registration and logon queries, please go to this website using the link: <b style="color:#245498;text-decoration:none;font-weight:normal"><a href="http://help.hobup.com" target="_blank">http://help.hobup.com</a></p>
                               <br> <br> 
